<template>
  <div class="container">
    ...
    <p>Each meeting we give a small lecture on a specific topic (ie Web Hacking, Cryptography, or Packet Sniffing), hold a discussion on recent events in the security community, and then work together on security challenges.</p>
    <h2 id="mailing-list">Mailing list</h2>
    <p>The Introsec mailing list is low volume (usually one message a week) and is used to announce:</p>
    <ul>
      <li class="row">
        <p>The topic of the next meeting</p>
      </li>
      <li class="row">
        <p>Upcoming CTFs that RPISEC or Introsec will be competing in</p>
      </li>
      <li class="row">
        <p>Major events in the security community</p>
      </li>
    </ul>
    ...
    <p>Next, show up! We hold meetings once a week, and will be happy to help you catch up after the lecture if you missed the first few weeks.</p>
    <hr />
